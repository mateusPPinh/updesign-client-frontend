...
const PlaceholderComponent = dynamic(() => import('@app/components/PlaceholderComponent').then((mod) => mod.default));
...
export default function Contact({ pageData, pageblockData }: ContactProps) {
